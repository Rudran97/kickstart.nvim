...
vim.keymap.set('n', '<leader>=f', '<cmd>CompareCurrentFile<CR>', { desc = '[=] Compare [F]ile' })
vim.keymap.set('n', '<leader>=d', '<cmd>CompareCurrentDirectory<CR>', { desc = '[=] Compare [D]irectory' })
